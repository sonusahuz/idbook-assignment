...
const SingleUserDetail = ({ id }: { id: string }) => {
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden max-w-sm w-full">
        <div className="p-6 space-y-2">
          ...
          <div className="pt-4 flex justify-between items-center">
            <Link
              href={`/update-user/${id}`}
              className="bg-blue-600 flex items-center justify-between gap-2 text-white py-2 px-4 rounded-md text-sm font-medium hover:bg-blue-700 transition-colors duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
            ...
            <button
              ...
              className="bg-red-600 text-white flex items-center justify-between gap-2 py-2 px-4 rounded-md text-sm font-medium hover:bg-red-700 transition-colors duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
